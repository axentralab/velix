      ...
      <div className="mx-auto max-w-6xl px-6 py-24 lg:py-32">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <p className="mb-4 text-sm uppercase tracking-[0.35em] text-slate-400">Luxury fashion</p>
            <h1 className="text-5xl font-black tracking-tight sm:text-6xl">Elevate your wardrobe with modern luxury.</h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Discover premium styling, signature pieces, and a fashion experience built for the discerning shopper.
            </p>
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="relative">
            <div className="aspect-[4/3] overflow-hidden rounded-[2.5rem] border border-white/10 bg-slate-800 shadow-2xl shadow-slate-900/40">
              <img src="https://images.unsplash.com/photo-1521334884684-d80222895322?auto=format&fit=crop&w=1200&q=80" alt="Luxury fashion" className="h-full w-full object-cover" />
            </div>
          </motion.div>
        </div>
      </div>
